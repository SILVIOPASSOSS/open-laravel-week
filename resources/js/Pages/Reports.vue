            ...
            <tr v-for="report in exports.data" :key="report.id">
              ...
              <TData type="action">
                <a :href="route('reports.show', report.id)"
                  class="flex flex-col items-center mx-auto p-4 bg-blue-900 text-white">Download</a>
              </TData>

              <TData type="action">
                <Link :href="route('reports.destroy', report.id)" method="delete"
                  class="flex mx-auto p-4 bg-gray-900 text-white" as="button">
                Delete
                </Link>
              </TData>
            </tr>
