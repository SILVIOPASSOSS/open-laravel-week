        ...
        <form @submit.prevent="submit">
          <div class="grid grid-cols-8 gap-4 flex flex-row items-end">
            <div class="col-span-4 lg:col-span-2">
              ...
              <TextInput placeholder="Name of the beer" id="beer_name" type="text" class="mt-1 block w-full"
            ...
            <div class="col-span-4 lg:col-span-2">
              ...
              <Select v-model="form.food" placeholder="Choose..." :options="meals" option-value="name"
                option-label="name" />
            </div>
            <div class="col-span-4 lg:col-span-1">
